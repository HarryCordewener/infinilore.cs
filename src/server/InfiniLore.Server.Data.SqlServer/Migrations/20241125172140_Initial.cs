    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserContentAccesses_Universes_ContentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "4f361a8d-9237-4393-a89f-f2c9edd97218", null, "admin", "ADMIN" },
                    { "fa4c7b7e-ada0-4dd0-838b-0cf33b7b912d", null, "user", "USER" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "d957c0f8-e90e-4068-a968-4f4b49fc165c", 0, "62d874f8-176e-4b4c-91e5-eb6911be9327", "testuser@example.com", true, false, null, "TESTUSER@EXAMPLE.COM", "TESTUSER", "AQAAAAIAAYagAAAAEGgvA/7Lip+LkdcmQj9FW4aYpnrw15pf69hC81Sv1k/ywPTd968x6eMNrNMXNNk33w==", null, false, "d957c0f8-e90e-4068-a968-4f4b49fc165b", false, "testuser" });
